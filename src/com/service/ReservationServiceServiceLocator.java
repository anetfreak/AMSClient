...
public class ReservationServiceServiceLocator extends org.apache.axis.client.Service implements com.service.ReservationServiceService {
    ...
    private java.lang.String ReservationService_address = "http://localhost:8080/AMS/services/ReservationService";
    ...
    public com.service.ReservationService getReservationService() throws javax.xml.rpc.ServiceException {
    ...
    public com.service.ReservationService getReservationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.ReservationServiceSoapBindingStub _stub = new com.service.ReservationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.ReservationService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.ReservationServiceSoapBindingStub _stub = new com.service.ReservationServiceSoapBindingStub(new java.net.URL(ReservationService_address), this);
                _stub.setPortName(getReservationServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.com", "ReservationServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.com", "ReservationService"));
        }
