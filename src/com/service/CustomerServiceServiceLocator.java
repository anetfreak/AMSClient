...
public class CustomerServiceServiceLocator extends org.apache.axis.client.Service implements com.service.CustomerServiceService {
    ...
    private java.lang.String CustomerService_address = "http://localhost:8080/AMS/services/CustomerService";
    ...
    public com.service.CustomerService getCustomerService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.CustomerServiceSoapBindingStub _stub = new com.service.CustomerServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.CustomerService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.CustomerServiceSoapBindingStub _stub = new com.service.CustomerServiceSoapBindingStub(new java.net.URL(CustomerService_address), this);
                _stub.setPortName(getCustomerServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.com", "CustomerServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.com", "CustomerService"));
        }
