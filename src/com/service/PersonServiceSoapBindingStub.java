...
public class PersonServiceSoapBindingStub extends org.apache.axis.client.Stub implements com.service.PersonService {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {username, password});
  ...
  throw axisFaultException;
    ...
    public boolean insertPerson(com.domain.Person person) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://service.com", "insertPerson"));
