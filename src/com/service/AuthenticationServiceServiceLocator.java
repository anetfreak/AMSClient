...
public class AuthenticationServiceServiceLocator extends org.apache.axis.client.Service implements com.service.AuthenticationServiceService {
    ...
    private java.lang.String AuthenticationService_address = "http://localhost:8080/AMS/services/AuthenticationService";
    ...
    public com.service.AuthenticationService getAuthenticationService() throws javax.xml.rpc.ServiceException {
    ...
    public com.service.AuthenticationService getAuthenticationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.AuthenticationServiceSoapBindingStub _stub = new com.service.AuthenticationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.AuthenticationService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.AuthenticationServiceSoapBindingStub _stub = new com.service.AuthenticationServiceSoapBindingStub(new java.net.URL(AuthenticationService_address), this);
                _stub.setPortName(getAuthenticationServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.com", "AuthenticationServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.com", "AuthenticationService"));
        }
